...
from src.models import Generator, Discriminator, TruncatedVGG19
...
srresnet_checkpoint = "./checkpoint_srresnet_B.pth.tar"  # filepath of the trained SRResNet checkpoint used for initialization
...
iterations = 2e3  # number of training iterations
